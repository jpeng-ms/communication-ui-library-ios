...
public class CallingSDKWrapper: NSObject, CallingSDKWrapperProtocol {
    ...
    public static var shared: CallingSDKWrapper!
    ...
    public func setupCall() -> AnyPublisher<Void, Error> {
        setupCallClientAndDeviceManager().eraseToAnyPublisher()
    }

    public func startCall(isCameraPreferred: Bool, isAudioPreferred: Bool) -> AnyPublisher<Void, Error> {
    ...
    public func endCall() -> AnyPublisher<Void, Error> {
        Future { promise in
    ...
    public func getRemoteParticipant(_ identifier: String) -> RemoteParticipant? {
        guard let call = call else {
            return nil
        }
    ...
    public func getLocalVideoStream(_ identifier: String) -> LocalVideoStream? {
    ...
    public func startCallLocalVideoStream() -> AnyPublisher<String, Error> {
    ...
    public func stopLocalVideoStream() -> AnyPublisher<Void, Error> {
        Future { promise in
    ...
    public func switchCamera() -> AnyPublisher<CameraDevice, Error> {
    ...
    public func startPreviewVideoStream() -> AnyPublisher<String, Error> {
    ...
    public func muteLocalMic() -> AnyPublisher<Void, Error> {
        Future { promise in
    ...
    public func unmuteLocalMic() -> AnyPublisher<Void, Error> {
        Future { promise in
    ...
    public func holdCall() -> AnyPublisher<Void, Error> {
        Future { promise in
    ...
    public func resumeCall() -> AnyPublisher<Void, Error> {
        Future { promise in
