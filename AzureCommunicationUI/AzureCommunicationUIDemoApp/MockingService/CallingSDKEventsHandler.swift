...
public class CallingSDKEventsHandler: NSObject, CallingSDKEventsHandling {
    ...
    public static var shared = CallingSDKEventsHandler()
    ...
    public func assign(_ recordingCallFeature: RecordingCallFeature) {
        self.recordingCallFeature = recordingCallFeature
        recordingCallFeature.delegate = self
    }

    public func assign(_ transcriptionCallFeature: TranscriptionCallFeature) {
