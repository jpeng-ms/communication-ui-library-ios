...
final class DependencyContainer {
    ...
    func registerDependencies(_ callConfiguration: CallConfiguration,
        ...
        register(CallingSDKEventsHandler.shared as CallingSDKEventsHandling)
        CallingSDKWrapper.shared = CallingSDKWrapper(logger: resolve(),
                                                     callingEventsHandler: resolve(),
                                                     callConfiguration: callConfiguration)
        register(CallingSDKWrapper.shared as CallingSDKWrapperProtocol)
