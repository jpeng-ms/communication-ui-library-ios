...
protocol MessageRepositoryMiddlewareHandling {
    ...
    // read receipt
    func sendMessageRead(messageId: String)
    func readReceiptReceived(participantState: ParticipantsState, eventTimestamp: UserEventTimestampModel)
}
...
class MessageRepositoryMiddlewareHandler: MessageRepositoryMiddlewareHandling {
    ...
    func sendMessageRead(messageId: String) {
        messageRepository.updateLocalParticipantLastRead(timestamp: Date())
    }

    func readReceiptReceived(participantState: ParticipantsState,
                             eventTimestamp: UserEventTimestampModel) {
